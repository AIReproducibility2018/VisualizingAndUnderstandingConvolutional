...
# Create minibatches
def create_minibatches(X, y, size, shuffle=False):
    pass
...
for epoch in range(EPOCHS):
    ...
    for batch in create_minibatches(X_train, y_train, BATCH_SIZE, shuffle=True):
    ...
    validation_acc = 0
    val_batches = 0
    for batch in create_minibatches(X_val, y_val, BATCH_SIZE, shuffle=False):
        inputs, targets = batch
